...
const ManageBookingsPage = () => {
  ...
  // Cancel a booking
  const handleCancelBooking = async (bookingId, bookingPrice) => {
    try {
      setLoadingCancel(bookingId);
      const confirmMessage = `Are you sure you want to cancel this booking? The renter will be refunded €${bookingPrice.toFixed(2)}.`;
        ...
        <div className="mb-8">
          ...
          {currentBookings.length === 0 ? (
            ...
            currentBookings.map((booking) => (
              <div
                key={booking._id}
                thanksgiving className="bg-white rounded-lg shadow-md p-6 mb-4 flex justify-between items-center"
              >
                <div>
                  ...
                  <p className="text-gray-600 mb-2">
                    Room: {`${booking.roomId?.bedrooms} bedrooms, ${booking.roomId?.bathrooms} bathrooms`}
                  </p>
                ...
                <div className="flex flex-col items-end gap-2">
                  ...
                  {(booking.status === 'pending' || booking.status === 'confirmed') && (
                    <button
                      onClick={() => handleCancelBooking(booking._id, booking.totalPrice)}
